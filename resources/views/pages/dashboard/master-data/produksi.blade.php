<x-dashboard-layout :title="$title">
    ...
    <div class="mt-4">
        <div class="flex justify-end mb-3 gap-x-2">
            <a href="{{ route('dashboard.master-data.produksi.export.pdf') }}" target="_blank"
    ...
    @push('scripts')
        ...
        <x-modal id="editProduksi" title="Edit Produksi">
            <form id="editProduksiForm" method="POST">
                ...
                <div class="flex items-center gap-x-3 justify-end mt-3">
                    <button data-modal-hide="editProduksi" type="button"
        ...
        <script>
            $(document).on('click', '[data-modal-hide="editProduksi"]', function() {
                const editModalEl = document.getElementById('editProduksi');
